...
export const Field = ({
  ...
  return (
    <NumberField
      ...
      // @ts-expect-error `null` is a bit of a hack to stop the number field
      // assuming this is an uncontrolled field. `undefined` here would cause it
      // to take over the value management.
